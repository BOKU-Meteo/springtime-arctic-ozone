# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 14:13:57 2025
...
path = 'C:/Users/...' #your path to the data folder
...
ax.legend(['OBS TCO', 'TCO ~ T$_{strat}$','TCO ~ TCO','TCO ~ V$_{psc}$','TCO ~ EHF'], loc='upper center', bbox_to_anchor=(0.5, -0.2),
...
plt.savefig(r''+str(path)+'final_vert_all_'+str(model)+'_'+datetime.today().strftime('%d%m%Y')+'.png',dpi=300,bbox_inches='tight') 
plt.close() 
